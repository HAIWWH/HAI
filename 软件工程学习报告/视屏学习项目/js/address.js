$.fn.sjld = function(shengfen,chengshi,quyu){
	var sfp = shengfen+' p'
	var csp = chengshi+' p'
	var qyp = quyu+' p'
	var sfs = shengfen+' .m_zlxg2'
	var css = chengshi+' .m_zlxg2'
	var qys = quyu+' .m_zlxg2'
	var sfli = shengfen+' ul li'
...
//	var kuandu = new Array();
	...
	for(a=0;a<sfgsmr.length;a++){
		...
		$(shengfen).find('ul').append(sfnrmr);
	}
...
/*---------------------------------------------------------------------*/
	...
	$(sfli).click(function(){
		var dqsf = $(this).text();
		$(shengfen).find('p').text(dqsf);
		$(shengfen).find('p').attr('title',dqsf);
